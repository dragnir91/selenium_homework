...
try: 
    ...
    input3.send_keys("a.s.malyshenko@gmail.com")    
    ...
    assert "Congratulations! You have successfully registered!" == welcome_text, f"Congratulations! You have successfully registered!"
